...
class OATraceCollector:
    ...
    def start_span(
        ...
        return {"span_id": span_id, "span_name": span_name}
    ...
    def end_span(
        ...
        """结束一个子 span"""
        span_id = span.get("span_id") if isinstance(span, dict) else span
        span_name = span.get("span_name", "unknown") if isinstance(span, dict) else span_name
...
class OACallbackHandler(BaseCallbackHandler):
    ...
    def __init__(
        ...
        self._collector = collector or OATraceCollector()
